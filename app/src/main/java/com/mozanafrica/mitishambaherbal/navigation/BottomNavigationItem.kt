...
sealed class BottomNavigationItem(
    ...
    object Home :
        BottomNavigationItem(R.string.home, R.drawable.ic_home_24, Screen.SingleCard.route)

    object Search :
        BottomNavigationItem(R.string.search, R.drawable.ic_search_24, Screen.SingleCard.route)

    object Favorite : BottomNavigationItem(
        R.string.favorites, R.drawable.ic_star_outline_24, Screen.SingleCard.route
    )
}